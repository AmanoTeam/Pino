...
<details>
<summary>Use the install script</summary>
...
This will download the GCC toolchain and install it to `/data/data/com.termux/files/usr/lib/pino`. After that, you can use the usual `gcc`, `g++`, `gfortran`, and `gcobol` to compile code directly from Termux.
...
* [AArch64](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/aarch64-apple-darwin.tar.xz)
* [x86_64](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/x86_64-apple-darwin.tar.xz)

## Linux (glibc)

* [AArch64](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/aarch64-unknown-linux-gnu.tar.xz)
* [x86_64](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/x86_64-unknown-linux-gnu.tar.xz)
* [i386](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/i386-unknown-linux-gnu.tar.xz)
* [ARMv7-A](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/arm-unknown-linux-gnueabihf.tar.xz)
* [ARMv4T](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/arm-unknown-linux-gnueabi.tar.xz)

## Linux (musl)

* [AArch64](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/aarch64-unknown-linux-musl.tar.xz)
* [x86_64](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/x86_64-unknown-linux-musl.tar.xz)
* [i386](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/i386-unknown-linux-musl.tar.xz)
* [ARMv7-A](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/armv7l-unknown-linux-musleabihf.tar.xz)
* [ARMv6](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/arm-unknown-linux-musleabihf.tar.xz)

## Android

* [AArch64](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/aarch64-unknown-linux-android.tar.xz)
* [x86_64](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/x86_64-unknown-linux-android.tar.xz)
* [i686](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/i686-unknown-linux-android.tar.xz)
* [ARMv7-A](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/armv7-unknown-linux-androideabi.tar.xz)

## FreeBSD

* [AArch64](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/aarch64-unknown-freebsd.tar.xz)
* [x86_64](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/x86_64-unknown-freebsd.tar.xz)
* [i386](https://github.com/AmanoTeam/Pino/releases/download/gcc-15/i386-unknown-freebsd.tar.xz)
...
Although precompiled binaries are available for *BSD and Haiku, the toolchain has been primarily tested on Linux and macOS. Please report any issues you encounter while using these binaries.
...
Using Pino in Gradle projects is a bit tricky. Both CMake and ndk-build are heavily tied to the NDK's internal structure, which makes it difficult to completely replace the NDK without risking breaking something in the build process.
...
Essentially, it overrides the NDK's `clang`/`clang++` commands with alternatives that call `gcc`/`g++` instead.
...
* Setting `PINO_STATIC = true` is equivalent to setting `ANDROID_STL = c++_static` in the upstream NDK.
* Setting `PINO_STATIC = false` is equivalent to setting `ANDROID_STL = c++_shared` in the upstream NDK.
...
* The HWAddressSanitizer (`-fsanitize=hwaddress`) runtime is broken. If you need it, use the older AddressSanitizer (`-fsanitize=address`) implementation instead.
...
The current development release is based on GCC 16 and supports cross-compiling software for all major Android architectures: `armv7`, `arm64`, `x86`, and `x86_64`. There is also experimental support for the `riscv64` architecture.
...
The toolchain includes support for the C/C++, Objective-C/Objective-C++, COBOL, and Fortran frontends.
