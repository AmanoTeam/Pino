...
Windows builds are not yet available, but support is planned. We also provide prebuilt binaries for many platforms not officially supported by the upstream NDK. Check the [releases](https://github.com/AmanoTeam/Pino/releases) section for the complete list.
...
* Targeting Android 10 (API level 29) or higher will still give you emulated TLS, despite bionic already supporting ELF TLS at that point.
