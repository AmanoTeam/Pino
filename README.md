...
Additionally, it allows cross-compiling for architectures that have been deprecated in the upstream NDK, including `armv5`, `mips`, and `mips64`.

Pino supports targeting Android versions from 4.0.1 (API level 14) up to Android 15 (API level 35).

You can obtain releases from the [releases](https://github.com/AmanoTeam/Pino/releases) page. Precompiled binaries of Pino are available for almost all platforms except Windows.
