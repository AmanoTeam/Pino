...
rm --force "${bindir}/gfortran"

printf "${wrapper}" "${pino_directory}/lib" "${pino_directory}/bin/${triplet}${api_level}-gfortran" > "${bindir}/gfortran"
chmod 700 "${bindir}/gfortran"

rm --force "${bindir}/gcobol"

printf "${wrapper}" "${pino_directory}/lib" "${pino_directory}/bin/${triplet}${api_level}-gcobol" > "${bindir}/gcobol"
chmod 700 "${bindir}/gcobol"
